...
const Properties = (props) => {
  ...
  useEffect(() => {
    ...
    props?.location?.state?.details?.house_category
      ? setPropertyType("House Property")
      : setPropertyType("Land Property");
  }, [props]);
    ...
    initialValues: {
      ...
      house_category:
        props?.location?.state?.details?.house_category
          ?.house_category,
      house_subcategory:
        props?.location?.state?.details?.house_subcategory
          ?.subcategory_name,
      land_category:
        props?.location?.state?.details?.land_category?.land_category,
      topography: props?.location?.state?.details?.topography,
      location: props?.location?.state?.details?.location,
      lga: props?.location?.state?.details?.lga,
      state: props?.location?.state?.details?.state,
      is_reserved: props?.location?.state?.details?.is_reservable,
      installment: props?.location?.state?.details?.installment,
      price: props?.location?.state?.details?.price,
      status: props?.location?.state?.details?.status,
      year_built: props?.location?.state?.details?.year_built,
      image_file: props?.location?.state?.details?.property_images,
      overview: props?.location?.state?.details?.overview,
      lat: props?.location?.state?.details?.lat,
      lng: props?.location?.state?.details?.lng,
      contact: props?.location?.state?.details?.contact,
      dimension: props?.location?.state?.details?.dimension,
      home_area: props?.location?.state?.details?.home_area,
      material: props?.location?.state?.details?.material,
      reference: props?.location?.state?.details?.reference,
      amenities: props?.location?.state?.details?.amenities,
      transaction: props?.location?.state?.details?.transaction,
      video_url: props?.location?.state?.details?.video_url,
      car_park: props?.location?.state?.details?.car_park,
      bathrooms: props?.location?.state?.details?.bathrooms,
      rooms: props?.location?.state?.details?.rooms,
    },
    onSubmit: (values) => {
        ...
        <form onSubmit={form.handleSubmit}>
          ...
          <div className="basic-info">
            <Radio
              ...
              disabled={propertyType !== "House Property"}
              checked={
                props?.location?.state?.details?.transaction ===
                "rent"
              }
              onChange={(e) => {
          ...
          >
            <CheckBox
              ...
              name="is_reserved"
              checked={props?.location?.state?.details?.is_reservable}
              onChange={(e) => {
            ...
            <CheckBox
              ...
              name="installment"
              checked={
                props?.location?.state?.details?.installment === "1"
              }
              onChange={(e) => {
          ...
          <div className="basic-info">
            <Autocomplete
              ...
              value={props?.location?.state?.details?.location}
              onBlur={(e) => {
          ...
          <div className="ammenities">
            {Ammenities.map((item, index) => (
              <CheckBox
                ...
                label={item}
                name={item}
                checked={props?.location?.state?.details?.amenities?.find(
          ...
          <VideoPicker
            ...
            videoUrl={props?.location?.state?.details?.video_url}
          />
          <ImagesUploader
            onChange={onChange}
            oldImages={
              props?.location?.state?.details?.house_image
                ? props?.location?.state?.details?.house_image
                : props?.location?.state?.details?.land_image
            }
          />
          <div className="header">
            <h6>contact info</h6>
